...
return {
	...
	Folded = { fg = cp.blue_1, bg = cp.surface1 }, -- line used for closed folds
	...
	Substitute = { fg = cp.red_1, bg = cp.surface0 }, -- |:substitute| replacement text highlighting
	LineNr = { fg = cp.overlay1 },

	CursorLineNR = { fg = cp.orange_1, bg = cp.surface0, style = { 'bold' } },
	...
	Title = { fg = cp.blue_1, style = { 'bold' } }, -- titles for output from ":set all", ":autocmd" etcp.
