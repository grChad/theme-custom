...
return {
	...
	-- for nvim nightly
	DiagnosticUnderlineError = { sp = error, style = { 'underline' } }, -- Used to underline "Error" diagnostics
	DiagnosticUnderlineWarn = { sp = warning, style = { 'underline' } }, -- Used to underline "Warn" diagnostics
	DiagnosticUnderlineInfo = { sp = info, style = { 'underline' } }, -- Used to underline "Info" diagnostics
	DiagnosticUnderlineHint = { sp = hint, style = { 'underline' } }, -- Used to underline "Hint" diagnostics
